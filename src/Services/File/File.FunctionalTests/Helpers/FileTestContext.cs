...
{
    public class FileTestContext<TStartup> : IDisposable where TStartup : class
    {
        private readonly Stopwatch _stopwatch;
        private readonly FileTestFixture<TStartup> _fixture;

        public FileTestContext(FileTestFixture<TStartup> fixture)
        {
